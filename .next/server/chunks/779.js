...
module.exports = createProxy("D:\\Web_Sound\\nextjs-mui-ts-starter\\node_modules\\@mui\\icons-material\\FavoriteBorder.js");
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(61363);
module.exports = createProxy("D:\\Web_Sound\\nextjs-mui-ts-starter\\node_modules\\@mui\\icons-material\\ThumbDownOffAlt.js");
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(61363);
module.exports = createProxy("D:\\Web_Sound\\nextjs-mui-ts-starter\\node_modules\\@mui\\icons-material\\Visibility.js");
...
__webpack_require__.d(__webpack_exports__, {
  Z: () => (/* binding */ wavesurfer)
});

;// CONCATENATED MODULE: ./node_modules/wavesurfer.js/dist/decoder.js
...
/* harmony default export */ const decoder = (Decoder);

;// CONCATENATED MODULE: ./node_modules/wavesurfer.js/dist/fetcher.js
var fetcher_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
function fetchBlob(url, progressCallback, requestInit) {
    var _a, _b;
    return fetcher_awaiter(this, void 0, void 0, function* () {
        // Fetch the resource
        ...
        // Read the data to track progress
        {
            ...
            // Process the data
            const processChunk = (done, value) => fetcher_awaiter(this, void 0, void 0, function* () {
                if (done)
                    return;
...
/* harmony default export */ const fetcher = (Fetcher);

;// CONCATENATED MODULE: ./node_modules/wavesurfer.js/dist/event-emitter.js
...
;// CONCATENATED MODULE: ./node_modules/wavesurfer.js/dist/player.js
...
;// CONCATENATED MODULE: ./node_modules/wavesurfer.js/dist/draggable.js
...
;// CONCATENATED MODULE: ./node_modules/wavesurfer.js/dist/renderer.js


class Renderer extends event_emitter {
...
;// CONCATENATED MODULE: ./node_modules/wavesurfer.js/dist/timer.js

class Timer extends event_emitter {
    constructor() {
        super(...arguments);
...
;// CONCATENATED MODULE: ./node_modules/wavesurfer.js/dist/wavesurfer.js
var wavesurfer_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class WaveSurfer extends player {
    ...
    loadAudio(url, blob, channelData, duration) {
        return wavesurfer_awaiter(this, void 0, void 0, function* () {
            this.emit('load', url);
            if (this.isPlaying())
                this.pause();
            this.decodedData = null;
...
/* harmony default export */ const wavesurfer = (WaveSurfer);
