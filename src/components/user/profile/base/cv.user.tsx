...
const projects = [
    {
        ...
        features: ["Nghe nhạc trực tuyến", "JWT",
            ...
            "Kết nối peer to peer ( WebRTC ) khi call trực tiếp giữa hai người",
            "Stream-io để có thể call và share màn hình: cùng nhau nghe bài hát và trò chuyện với nhiều người",
